        ...
        <View style={{flex: 1}}>
            ...
            <View style={styles.background}>
                <View style={styles.center}>
                    <Text style={{marginBottom: 20, fontSize: 20}}>Searching for an opponent</Text>
                    <ActivityIndicator color='#1A1F16' style={{marginBottom: 20}} size="large" animating={true}></ActivityIndicator>
                    <CustomButton title="Leave queue" onPress={ () => leaveQueue()} disabled={false} />
                </View>
            </View>
            </ImageBackground>
        </View>
